        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          >
                ...
                {contactMethods.map((method, i) => (
                  <div key={i} className="flex items-start space-x-4 p-3 hover:bg-gray-50/80 rounded-lg transition">
                    ...
                    <div>
                      ...
                      <p className="font-medium text-gray-800">{method.details}</p>
                      <a 
                        href={method.actionLink} 
                        className="inline-block mt-2 text-sm text-teal-600 font-medium hover:text-teal-700"
                      >
                        {method.action} →
                      </a>
                    </div>
            ...
            <div className="bg-white/90 backdrop-blur-sm p-6 rounded-xl shadow-lg border border-white/20">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <p className="text-gray-800 font-medium">Jagdamba Senior Care</p>
                  <p className="text-gray-600">123 Care Street, Patna</p>
          ...
          >
            <div className="flex border-b border-gray-200 mb-6">
              <button
                className={`py-2 px-4 font-medium ${activeTab === 'form' ? 'text-teal-600 border-b-2 border-teal-600' : 'text-gray-500'}`}
                onClick={() => setActiveTab('form')}
              >
                Send Message
              </button>
              <button
                className={`py-2 px-4 font-medium ${activeTab === 'callback' ? 'text-teal-600 border-b-2 border-teal-600' : 'text-gray-500'}`}
            ...
            {activeTab === 'form' ? (
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                    />
                  </div>
                  ...
                  <button
                    type="submit"
                    className="w-full bg-teal-600 hover:bg-teal-700 text-white font-semibold py-3 rounded-lg shadow-md hover:shadow-lg transition duration-300"
                  >
                    Send Message
                  </button>
                </div>
              ...
              <form onSubmit={handleSubmit}>
                <div className="space-y-4">
                  ...
                  <div>
                    <label htmlFor="callback-time" className="block text-sm font-medium text-gray-700 mb-1">Preferred Callback Time</label>
                    <select
                      name="time"
                      id="callback-time"
                      className="w-full border border-gray-300 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:border-transparent"
                  ...
                  <div>
                    <label htmlFor="callback-notes" className="block text-sm font-medium text-gray-700 mb-1">Any Notes</label>
                    <textarea
                      name="notes"
                      id="callback-notes"
                      rows="2"
